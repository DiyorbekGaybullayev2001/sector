...
const Sidebar = () => {
  ...
  const newsItems = t('sidebar.newsItems', { returnObjects: true });
  const projectsItems = t('sidebar.projectsItems', { returnObjects: true });
  const worksItems = t('sidebar.worksItems', { returnObjects: true });

  return (
    <div className="space-y-6">
      <div className="bg-white shadow-md rounded-2xl p-4 border-b-blue-600 border-b-4">
        <h2 className="text-lg font-bold mb-3">{t('sidebar.news')}</h2>
      ...
      <div className="bg-white shadow-md mt-[50px] rounded-2xl p-4 border-b-blue-600 border-b-4">
        <h2 className="text-lg font-bold mb-3">{t('sidebar.projects')}</h2>
        <ul className="list-disc ml-5">
          {projectsItems.map((item, index) => (
            <li key={index} className="text-sm hover:text-blue-600">
              <a href="#">{item.title}</a>
            </li>
          ))}
        </ul>
      ...
      <div className="bg-white shadow-md mt-[50px] rounded-2xl p-4 border-b-blue-600 border-b-4">
        <h2 className="text-lg font-bold mb-3">{t('sidebar.works')}</h2>
        <ul className="list-disc ml-5">
